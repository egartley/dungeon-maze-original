...
class ArrowBooster(Booster):
    ...
    def __init__(self):
        super().__init__()
        self.increase = 10
        self.sprite = image.load('src/sprites/Boosters/arrow.png')
...
class HealthBooster(Booster):
    ...
    def __init__(self):
        ...
        self.sprite = image.load('src/sprites/Boosters/health-booster.png')
        self.sprite = transform.scale(self.sprite, (20,20))
        self.rect = self.sprite.get_rect()
...
class ShieldBooster(Booster):
    ...
    def __init__(self):
        ...
        self.sprite = image.load('src/sprites/Boosters/Shields.png')
        self.sprite = transform.scale(self.sprite, (20,20))
        self.rect = self.sprite.get_rect()
