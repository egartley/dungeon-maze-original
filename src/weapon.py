...
class Sword(Weapon):
    ...
    def right_animation(self):
        self.sprites_right_swing.append(pygame.image.load('src/sprites/Weapons/Sword/sprite_swing_sword_right0.png'))
        self.sprites_right_swing.append(pygame.image.load('src/sprites/Weapons/Sword/sprite_swing_sword_right1.png'))
    ...
    def left_animation(self):
        ...
        self.sprites_left_swing.append(pygame.image.load('src/sprites/Weapons/Sword/sprite_swing_sword_left1.png'))
